    ...
    return (
      <div style={{ display: 'flex', flex: 1, alignItems: 'center', justifyContent: 'center', minHeight: '100vh', backgroundColor: 'hsl(var(--bg-primary))' }}>
        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '16px' }}>
          ...
          <span style={{ fontSize: '0.9rem', color: 'hsl(var(--text-secondary))', fontWeight: 500 }}>Initializing Schedulify Admin Console...</span>
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap', gap: '15px' }}>
          <div>
            ...
            <p style={{ color: 'hsl(var(--text-secondary))', fontSize: '0.85rem' }}>
              Overview and configuration panel for Schedulify.
            </p>
          </div>
            ...
            <div className="glass-card" style={{
              ...
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', borderBottom: '1px solid hsl(var(--border-color))', paddingBottom: '12px' }}>
                <div>
                  ...
                  <p style={{ fontSize: '0.75rem', color: 'hsl(var(--text-secondary))' }}>Configure standard active weekday hours inside Schedulify.</p>
                </div>
              ...
              <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '16px' }}>
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: '4px' }}>
                  ...
                  <input
                    id="fb-domain"
                    type="text"
                    placeholder="schedulify-app.firebaseapp.com"
